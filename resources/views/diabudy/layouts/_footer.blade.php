<footer class="background-dark text-grey" id="footer">
    <div class="footer-content">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="footer-logo float-left">
                        <img alt="" src="/diabudy/images/logo-sm-dark.png">
                    </div>
                    <p style="margin-top: 12px;"> is launching soon
                    </p>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="widget clearfix widget-contact-us" style="background-image: url('/diabudy/images/world-map.png'); background-position: 50% 55px; background-repeat: no-repeat">
                        ...
                        <ul class="list-large list-icons">
                            ...
                            <li><i class="fa fa-envelope"></i><strong>Email:</strong> <a href="mailto:support@diabudy.com">support@diabudy.com</a>
                            </li>
                ...
                <div class="col-md-4">
                    <div class="widget clearfix widget-tweeter">
                        <h4 class="widget-title">Diabudy Activities</h4>
                    </div>
                </div>
    ...
    <div class="copyright-content">
        <div class="container">
            <div class="row">
                <div class="copyright-text col-md-6"> &copy; 2018 DIABUDY - Best Buddy ever. All Rights Reserved. <a target="_blank" href="http://www.diabudy.com">DIABUDY</a>
                </div>
