...
<div class="row">
    <div class="form-group">
        ...
        <textarea class="form-control" name="post_content" placeholder="Write Content Here" id="articleContent" aria-required="true">@if(isset($post)){{$post->content}} @endif</textarea>
    </div>
</div>
