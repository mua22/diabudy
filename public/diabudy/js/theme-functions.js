    ...
    INSPIRO.loader = function () {
        ...
        if (!$body.hasClass('no-page-loader')) {
            ...
            var pageInAnimation = $body.attr('data-animation-in') || "fadeIn",
                ...
                pageLoaderStylePath = $body.attr('data-animation-icon-path') || "/diabudy/images/svg-loaders/",
        ...
        if ($map.exists()) {
            ...
            $map.each(function () {
                ...
                var $elem = $(this),
                    ...
                    mapIcon = $elem.attr('data-map-icon') ? $elem.attr('data-map-icon') : "/diabudy/images/markers/marker2.png";
